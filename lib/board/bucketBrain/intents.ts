...
const ROLE_TERMS =
  /\b(cinematographer|filmmaker|filmmakers|director|directors|writer|writers|editor|editors|producer|producers|vfx|blender|costume|designer|designers|actor|actors|composer|photographer|photographers|musician|musicians|stunt|wardrobe|hmu|dp|camera)\b/i;
