...
set
  ...
  is_official = true,
  coming_soon = false,
  description = 'The JAB Visions project room for Those Ryderz — auditions, self-tapes, production, crew, and Drops. Invite collaborators, post updates, and keep the film moving.',
