...
export default function BoardError({
  ...
  useEffect(() => {
    console.error("[Board] route render failed", error);
  }, [error]);
  ...
  return (
    <main className="min-h-screen px-5 py-10 text-[#241f12]">
      <section className="mx-auto max-w-xl rounded-[30px] border border-black/10 bg-white/70 p-6 text-center shadow-2xl backdrop-blur-xl">
        ...
        <h1 className="mt-3 text-2xl font-black">This page lost its signal.</h1>
        <p className="mt-2 text-sm font-semibold text-black/55">
          Your Board is still safe. Retry this page or head back to the hub.
        </p>
