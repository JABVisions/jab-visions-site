...
// Ruby and Keven were swapped previously.
// Now swap Keven and Zoe so Zoe appears before Keven.
const RYDERZ = [
  { // 1
    name: 'Rubi Wong',
    title: 'The Red Ryder',
...
export default function ThoseRyderz() {
  return (
    <>
      {/* Navbar now includes the JAB banner above the sticky nav */}
      <Navbar />
      ...
      <main className="min-h-screen bg-neutral-900 flex flex-col items-center justify-start px-0 relative overflow-hidden">
        ...
        <style jsx global>{`
          ...
          .shine-in-text {
            ...
            position: relative;
            background:
              linear-gradient(112deg,#fdfdfd 0%,#c7cbd1 16%,#b1b3b6 29%,#ededed 36%,#f8f8fc 49%,#c9dbfe 56%,#f9f4ff 60%,#c1f8ff 68%,#dadada 76%,#ffffff 100%),
